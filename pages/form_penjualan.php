					...
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="separator">
								...
								<form action="../backend/tambah_penjualan.php" method="POST">
									<div class="row">
										<div class="col-lg-12">
											<div class="form-row">
											<div class="form-group col-md-6">
												...
												<div class="form-group col-md-6">
													...
													<input type="text" name="Kembali" class="form-control" id="Kembalian">
												</div>
											</div>
										</div>
									</div>
										<div class="card-action">
											<a href="penjualan.php">
												<button type="submit" name="tambah_penjualan" class="btn btn-warning mx-2">Tambah</button>
											</a>
